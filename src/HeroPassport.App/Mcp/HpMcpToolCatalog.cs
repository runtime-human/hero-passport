    ...
    private static JsonElement FinishQuestOutputSchema() => ParseWithUuid("""
        {
          ...
          "properties":{
            ...
            "reward":{"type":"object","properties":{"baseXp":{"type":"integer","minimum":0},"bonusXp":{"type":"integer","minimum":0},"penaltyXp":{"type":"integer","minimum":0},"rawXp":{"type":"integer","minimum":0},"outcomePermille":{"type":"integer","minimum":0,"maximum":1000},"xpGained":{"type":"integer","minimum":0},"rewardRuleVersion":{"type":"string"},"components":{"type":"array","items":{"type":"object"}}},"required":["baseXp","bonusXp","penaltyXp","rawXp","outcomePermille","xpGained","rewardRuleVersion","components"],"additionalProperties":false},
          ...
          "required":["questId","result","replayed","alreadyFinalized","reward","heroProgress","trustStrain","streak","skillProgress","traitsUnlocked","titlesUnlocked","activeTitle","milestones","displayText"],
          "additionalProperties":false
        }
        """);
    ...
    private static JsonElement CardOutputSchema() => ParseWithUuid("""
        {
          "type":"object",
          "properties":{
            "hero":{"type":"object","properties":{"heroId":{"type":"string","pattern":"$UUID7$"},"name":{"type":"string"},"totalXp":{"type":"integer","minimum":0},"level":{"type":"integer","minimum":1},"isLevelCapped":{"type":"boolean"},"levelXp":{"type":"integer","minimum":0},"nextLevelXpRequired":{"type":"integer","minimum":1},"rankKey":{"type":"string"},"activeTitle":{"type":["string","null"]},"trust":{"type":"integer","minimum":0,"maximum":100},"strain":{"type":"integer","minimum":0,"maximum":100},"successStreak":{"type":"integer","minimum":0},"topSkills":{"type":"array","items":{"type":"object","properties":{"skillKey":{"type":"string"},"xp":{"type":"integer","minimum":0},"level":{"type":"integer","minimum":1},"isLevelCapped":{"type":"boolean"},"nextLevelXpRequired":{"type":"integer","minimum":1}},"required":["skillKey","xp","level","isLevelCapped"],"additionalProperties":false}},"traits":{"type":"array","items":{"type":"string"}},"titles":{"type":"array","items":{"type":"string"}}},"required":["heroId","name","totalXp","level","isLevelCapped","levelXp","rankKey","activeTitle","trust","strain","successStreak","topSkills","traits","titles"],"additionalProperties":false},
