    ...
    private static JsonElement FinishQuestOutputSchema() => ParseWithUuid("""
        {
          ...
          "properties":{
            ...
            "reward":{"type":"object","properties":{"baseXp":{"type":"integer","minimum":0},"bonusXp":{"type":"integer","minimum":0},"penaltyXp":{"type":"integer","minimum":0},"rawXp":{"type":"integer","minimum":0},"outcomePermille":{"type":"integer","minimum":0,"maximum":1000},"xpGained":{"type":"integer","minimum":0},"rewardRuleVersion":{"type":"string"},"components":{"type":"array","items":{"type":"object","properties":{},"additionalProperties":false}}},"required":["baseXp","bonusXp","penaltyXp","rawXp","outcomePermille","xpGained","rewardRuleVersion","components"],"additionalProperties":false},
