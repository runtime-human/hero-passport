...
[Migration("20260813173100_AddMutationReceipts")]
public sealed class AddMutationReceipts : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.CheckConstraint("ck_mutation_receipts_hash", "length(args_hash) = 32");
    ...
    {
        migrationBuilder.DropTable(name: "mutation_receipts");
    }
}
