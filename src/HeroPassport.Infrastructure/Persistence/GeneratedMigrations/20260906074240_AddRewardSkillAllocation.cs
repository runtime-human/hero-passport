...
{
    /// <inheritdoc />
    public partial class AddRewardSkillAllocation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_quest_reward_components_delta", "xp_delta BETWEEN -9007199254740991 AND 9007199254740991");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    quest_report_id = table.Column<string>(type: "TEXT", nullable: false),
                    ordinal = table.Column<int>(type: "INTEGER", nullable: false),
                    level_after = table.Column<int>(type: "INTEGER", nullable: true),
                    level_before = table.Column<int>(type: "INTEGER", nullable: true),
                    skill_key = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_quest_report_skills_level_after", "level_after IS NULL OR level_after BETWEEN 1 AND 10");
                    table.CheckConstraint("ck_quest_report_skills_level_before", "level_before IS NULL OR level_before BETWEEN 1 AND 10");
